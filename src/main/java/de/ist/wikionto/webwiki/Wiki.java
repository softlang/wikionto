...
public class Wiki implements Serializable
{
    ...
    public static void main(String[] args) throws IOException {
		...
		String[] s = w.getCategoryMembers("Computer languages", Wiki.CATEGORY_NAMESPACE);
		for(String c : s){
			System.out.println(c);
		}
	}
    
    public String[] getSuperCategories(String name) throws IOException{
    	return getCategories("Category:"+name, false, true);
    }
}
